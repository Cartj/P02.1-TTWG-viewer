...
START = {
    # profile name
    PROFILE_NAME: "P02.1 Camera - LM10",
    # used for file saving purposes
    PROFILE_NICKNAME: "LM10",
    PROFILE_TANGOATTR: [
            # NICK + CMD; CMD - lambda function to execute
            {
                # must be unique
                NICK: "LM10",
                CMD: lambda: read_attribute("haspp02ch1:10000/hasylab/p02_lm10/output", "frame", expected_type=list),

                # parameters for the VIEW ROI - x and y are inverted, w and h are same
                ROI_VIEW:   [ 513-50, 685+3-50,  100, 100],
