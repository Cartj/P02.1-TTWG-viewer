...
START = {
    # profile name
    PROFILE_NAME: "P02.1 Camera - LM11",
    # used for file saving purposes
    PROFILE_NICKNAME: "LM11",
    PROFILE_TANGOATTR: [
            # NICK + CMD; CMD - lambda function to execute
            {
                # must be unique
                NICK: "LM11",
                CMD: lambda: read_attribute("haspp02ch1:10000/hasylab/p02_lm11/output", "frame", expected_type=list),

                # parameters for the VIEW ROI - x and y are inverted, w and h are same
                ROI_VIEW:   [ 339, 251, 70, 70],
